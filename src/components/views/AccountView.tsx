  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5 pb-16">
      ...
      <div className="p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-md flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            className="p-2 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 text-xs font-bold flex items-center gap-1.5"
            title="Scan Warranty QR Code"
          >
      ...
      <ConfirmModal
        ...
        title="Thibitisha Kujitoa (Logout Confirmation)"
        message="Je, una uhakika unataka kutoka kwenye akaunti yako ya YMA Energy?"
        type="logout"
      />
    </div>
  );
